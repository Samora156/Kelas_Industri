...
@section('content')
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                {{-- <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('siswa.create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            <!--begin::Svg Icon | path:demo13/dist/assets/media/svg/icons/Design/Flatten.svg--><svg
        ...
        <!-- Modal-->
        <div class="modal fade" id="kelasModal" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@push('script')
    ...
    <script src="assets/js/datatables/kelas.js?v=7.0.6"></script>
