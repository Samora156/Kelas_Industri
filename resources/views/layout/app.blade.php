...
<head>
	<base href="../../../">
	<meta charset="utf-8" />
	<title>Siswa ― Kelas Industri</title>
	...
	<link href="assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.6" rel="stylesheet"
		type="text/css" />
...
<script src="assets/js/pages/features/miscellaneous/sweetalert2.js?v=7.0.6"></script>
...
<!--end::Page Vendors-->
 ...
 {{-- <script src="assets/js/pages/crud/datatables/search-options/column-search.js?v=7.0.6"></script> --}}
 <!--end::Page Scripts-->
